...
public class CalculoAlquiler extends javax.swing.JFrame {
    ...
    public CalculoAlquiler() {
        ...
        fecha_finaltxt.setEnabled(false);
    ...
    private void mostrarImporteDiario() {
        ...
        DefaultTableModel modelo = dao.MostrarImporteDiario(cuotas, fecha, total_rent, sumaCapital, sumaInteres);
    ...
    private void mostrarImporteSemanal() {
        ...
        DefaultTableModel modelo = dao.MostrarImporteSemanal(cuotas, fecha, total_rent, sumaCapital, sumaInteres);
    ...
    private void mostrarImporteQuincenal() {
        ...
        DefaultTableModel modelo = dao.MostrarImporteQuincenal(cuotas, fecha, total_rent, sumaCapital, sumaInteres);
    ...
    private void mostrarImporteMensual() {
        ...
        DefaultTableModel modelo = dao.MostrarImporteMensual(cuotas, fecha, total_rent, sumaCapital, sumaInteres);
    ...
    private void initComponents() {
        ...
        fecha_finaltxt = new com.toedter.calendar.JDateChooser();
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(interesestxt, javax.swing.GroupLayout.PREFERRED_SIZE, 97, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(22, 22, 22))
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                        .addComponent(fecha_finaltxt, javax.swing.GroupLayout.PREFERRED_SIZE, 106, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                            .addComponent(mensualtxt, javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(cuartostxt, javax.swing.GroupLayout.Alignment.LEADING, 0, 86, Short.MAX_VALUE))))
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(search, 0, 498, Short.MAX_VALUE)
                        .addGap(18, 18, 18)
    ...
    private void tbTotalCalculoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbTotalCalculoMouseClicked
       CalcularAlquilerDAO dao = new CalcularAlquilerDAO();
       dao.SeleccionarCalculoAlquiler(tbTotalCalculo,idtxt, dnitxt, search, alquilertxt,garantiatxt, pisostxt, cuartostxt,interesestxt,totaltxt,totalAlquilertxt,fechatxt,fechaingresotxt,mensualtxt, selectPago, pagoDiariotxt , pagoSemtxt, pagoQuincenaltxt,ructxt,direcciontxt,telefonotxt,fecha_finaltxt);
...
private void exportarAExcel() {
    ...
    private com.toedter.calendar.JDateChooser fecha_finaltxt;
